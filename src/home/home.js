        ...
        <EmptyDiv2 width={width} >
            <BottomTopDiv width={width}>
                ...
                <BottomTopBoxDiv width={width}>
                    <BottomTopBoxDivNestedDiv width={width} onClick={()=>{props.history.push('/moreview/1')}}>
                        <BottomTopBoxDivNestedDivDiv1 width={width}>
                            <BottomTopBoxDivNestedDivDiv1Span width={width}>'투닝' 시범서비스 오픈</BottomTopBoxDivNestedDivDiv1Span>
                        </BottomTopBoxDivNestedDivDiv1>
                        <BottomTopBoxDivNestedDivDiv2 width={width}>
                            <BottomTopBoxDivNestedDivDiv2Span width={width}>2021년 11월 01일</BottomTopBoxDivNestedDivDiv2Span>
                    ...
                    <BottomTopBoxDivDiv width={width}>
                        <BottomTopBoxDivDivButton width={width} onClick={()=>{props.history.push('/more/1')}}></BottomTopBoxDivDivButton>
                    </BottomTopBoxDivDiv>
                </BottomTopBoxDiv>
            </BottomTopDiv>
...
const TopLineButtonText = styled.span`
    ...
    line-height:${props => parseInt(props.width * ratio / 38.4) > 13 ? parseInt(props.width * ratio / 38.4) + 'px' : '13px'};
    font-family: 'NanumSquareRegular';
    cursor: pointer;
`;
const TopLineMessage = styled.div`
    ...
    line-height:${props => parseInt(props.width * ratio / 16) > 13 ? parseInt(props.width * ratio / 16) + 'px' : '13px'};
    font-family: 'NanumSquareRegular';
    font-weight:800;
    color:#FFFFFF;
`;
const TopLineMessage2 = styled.div`
    ...
    line-height:${props => parseInt(props.width * ratio / 40) > 13 ? parseInt(props.width * ratio / 40) + 'px' : '13px'};
    font-family: 'NanumSquareRegular';
    font-weight:800;
    color:#FFFFFF;
`;
...
const TextDivDiv = styled.div`
    ...
    margin-right:${props => props.number === 4 ? null : parseInt(props.width / 35.5) + 'px'};
    display:flex;
    flex-direction:column;
`;
const TextDivTitle = styled.span`
    ...
    line-height:${props => parseInt(props.width * ratio / 26.3) > 13 ? parseInt(props.width * ratio / 26.3) + 'px' : '13px'};
    font-family: 'NanumSquareRegular';
    font-weight:800;
    color:#FFFFFF;
`;
const TextDivContent = styled.span`
    ...
    line-height:${props => parseInt(props.width * ratio / 41.3) > 13 ? parseInt(props.width * ratio / 41.3) + 'px' : '13px'};
    font-family: 'NanumSquareRegular';
    font-weight:400;
    color:#FFFFFF;
`;
...
const Number3Text = styled.span`
    ...
    line-height:${props => parseInt(props.width * ratio / 18.3) > 13 ? parseInt(props.width * ratio / 18.3) + 'px' : '13px'};
