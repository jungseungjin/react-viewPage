            ...
            <BottomTopDiv width={width}>
                ...
                <BottomTopBoxDiv width={width}>
                    <TermDiv width={width}>
                        ...
                        이 약관은 오토베이크(이하 “회사”라 합니다)가 제공하는 투닝 서비스(이하 “서비스”라 합니다)와 관련하여 “회사”와 “이용자”의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다. 본 약관은 PC통신, 스마트폰 앱 등을 이용하는 경우에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.
                        </TermDivSpan>
                    </TermDiv>
                    <TermDiv width={width}>
                        <TermDivTitle width={width}>
                        ...
                        <TermDivSpan width={width}>
                            <ul style={{paddingInlineStart: 3}}>
                                <li style={{listStyle: 'none'}}>
                                    ...
                                    <TermDivSpanSpan >“플랫폼”이란 “업주가 “이용자”에게 재화 또는 서비스 상품을 예약 및 판매하기 위해 “회사”가 제공하는 가상의 영업장을 말합니다.</TermDivSpanSpan>
                                </li>
                                <li style={{listStyle: 'none'}}>
                                    <TermDivSpanSpan> 2. </TermDivSpanSpan>
                                    <TermDivSpanSpan >“이용자”란 “플랫폼”을 통하여 이 약관에 따라 서비스를 이용하는 자를 말하며, 회원과 비회원을 모두 포함합니다.</TermDivSpanSpan>
                                </li>
                                <li style={{listStyle: 'none'}}>
                                    <TermDivSpanSpan> 3. </TermDivSpanSpan>
                                    <TermDivSpanSpan >“회원”이라 함은 “플랫폼”에 개인정보를 제공하여 회원등록을 한 자로서, “플랫폼”이 제공하는 투닝 서비스를 계속적으로 이용할 수 있는 자를 말합니다.</TermDivSpanSpan>
                                </li>
                                <li style={{listStyle: 'none'}}>
                                    <TermDivSpanSpan> 4. </TermDivSpanSpan>
                                    <TermDivSpanSpan >“비회원”이라 함은 “회원”에 가입하지 않고 “플랫폼”이 제공하는 서비스를 이용하는 자를 말합니다.</TermDivSpanSpan>
                                </li>
                                <li style={{listStyle: 'none'}}>
                                    <TermDivSpanSpan> 5. </TermDivSpanSpan>
                                    <TermDivSpanSpan >“게시물”이라 함은 “회원”이 “플랫폼”을 이용함에 있어서 게시한 문자·화상·동영상·음성·음향 등의 정보를 포함한 글, 사진, 동영상 등 각종 파일과 링크 등을 의미합니다.</TermDivSpanSpan>
                                </li>
                                <li style={{listStyle: 'none'}}>
                                    <TermDivSpanSpan> 6. </TermDivSpanSpan>
                                    <TermDivSpanSpan >“비밀번호(Password)”라 함은 “회원”의 식별과 회원의 정보를 보호하기 위하여 회원 스스로가 설정하여 등록한 영문과 숫자 등의 조합을 말합니다.</TermDivSpanSpan>
                                </li>
                                <li style={{listStyle: 'none'}}>
                                    <TermDivSpanSpan> 7. </TermDivSpanSpan>
                                    <TermDivSpanSpan >“업주”란 “회사”가 제공하는 “서비스”를 이용해 재화 또는 서비스 상품에 대한 정보를 게재 및  판매(예약, 작업 및 A/S포함)하는 주체를 말합니다.</TermDivSpanSpan>
                                </li>
                            </ul>
                        </TermDivSpan>
                    </TermDiv>
