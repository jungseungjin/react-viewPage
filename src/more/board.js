        ...
        <EmptyDiv2 width={width} >
            <BottomTopDiv width={width}>
                ...
                <BottomTopBoxDiv width={width}>
                    <BoardOne  width={width} onClick={BoardClick}>
                        <BoardOneTitle  width={width}>개인정보처리방침 일부 변경에 관한 안내</BoardOneTitle>
                        <BoardOneDate  width={width}>2021.09.11</BoardOneDate>
                    </BoardOne>
                    <BoardOne  width={width}  onClick={BoardClick}>
                        <BoardOneTitle  width={width}>개인정보처리방침 일부 변경에 관한 안내</BoardOneTitle>
                        <BoardOneDate  width={width}>2021.09.11</BoardOneDate>
                    ...
                    <PageDiv width={width}>
                    <Pagination defaultCurrent={1} total={50} /></PageDiv>
                </BottomTopBoxDiv>
            </BottomTopDiv>
